...
- Middle Position Single-Clip Canary current evidence: Admission ADMITTED; Apply State VERIFIED; Apply Dispatches 1; Apply Writes 1; Apply Receipt VERIFIED; Rollback Available true; Rollback State VERIFIED; Rollback Dispatches 1; Rollback Writes 1; Rollback Receipt VERIFIED; Final State ORIGINAL_BEFORE_STATE_RESTORED; Batch Apply OFF; Production Use OFF; Parallel Host Mutation OFF.
