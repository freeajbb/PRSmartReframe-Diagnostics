...
- Phase 5B-3 has highest diagnostic priority: verify source reservation SHA, Fresh pre-write Host state, exact fingerprint/before-state gate, write/readback/ownership evidence, measured Premiere Write Calls, Provider Calls 0, immutable receipt, and Dedicated Rollback only when present.
