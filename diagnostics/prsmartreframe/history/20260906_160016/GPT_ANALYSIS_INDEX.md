...
- Phase 5B-2 has highest diagnostic priority: verify exactly one Phase 5B-1 READY source, fresh Host revalidation, deterministic transaction reservation only for AUTHORIZED, Premiere Write Calls 0, Provider Calls 0, writeAllowed=false/applyAllowed=false, and Authorization != Apply.
